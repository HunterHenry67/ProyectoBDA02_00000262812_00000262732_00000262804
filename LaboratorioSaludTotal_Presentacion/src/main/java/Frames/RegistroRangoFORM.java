...
public class RegistroRangoFORM extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RegistroRangoFORM
     */
    public RegistroRangoFORM() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroRangoFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroRangoFORM().setVisible(true);
            }
        });
    }
