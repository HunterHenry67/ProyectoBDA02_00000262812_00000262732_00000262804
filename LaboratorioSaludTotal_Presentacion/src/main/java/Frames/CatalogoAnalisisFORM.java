...
public class CatalogoAnalisisFORM extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CatalogoAnalisisFORM
     */
    public CatalogoAnalisisFORM() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatalogoAnalisisFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CatalogoAnalisisFORM().setVisible(true);
            }
        });
    }
